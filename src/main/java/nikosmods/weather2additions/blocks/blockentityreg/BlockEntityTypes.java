...
import nikosmods.weather2additions.blocks.blockfunction.*;
...
public class BlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<ScreenBlockEntity>> SCREEN_BLOCK_ENTITY = blockEntityType.register("screen_block", () -> BlockEntityType.Builder.of(ScreenBlockEntity::new, Blocks.SCREEN_BLOCK.get()).build(null));
