...
public class Blocks {
    ...
    public static final RegistryObject<Block> CABLE = blocks.register("cable", () -> new CableSmall(BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.STONE)));
